...
<html lang="en">
  ...
  <div class="row">
        ...
        <div class="">
        <ul>
          <li><a href="{{route('userPosts',['id'=>Auth::id()])}}" class="nav-link px-2 text-primary">My posts</a></li>
          <li><a href="{{route('showBasket')}}" class="nav-link px-2 text-primary">Basket</a></li>
          <li><a href="{{route('showAddForm')}}" class="nav-link px-2 text-primary">Add offer</a></li>
          <li><a href="{{route('showFilterForm')}}" class="nav-link px-2 text-primary">Filter</a></li>
        </ul>
        </div>
        </div>
          <div class="col-md-10">
